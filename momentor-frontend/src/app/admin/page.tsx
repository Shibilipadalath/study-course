    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-lg bg-[#B08D55]/10 flex items-center justify-center">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-[#B08D55] hover:bg-[#B08D55]/5 transition-colors text-left">
