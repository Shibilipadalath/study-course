...
export default function Footer() {
  return (
    <footer className="w-full bg-black pt-12 py-6 relative">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-6 text-gray-300 max-w-xs text-justify">
              Momentor is India’s first education journalism + future-skills mentorship
              platform guiding youth with clarity, skills, and global career opportunities.
            </p>

            <p className="mt-6 font-semibold text-white text-[15px]">
              Social Media
            </p>
          ...
          <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-10">
            ...
            {/* Company */}
            <div>
              <h3 className="font-semibold text-white mb-4 text-[15px]">
                Company
              </h3>
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-300 leading-5 mb-5">
              Have questions? We’re here to guide you. Reach out to our team anytime.
            </p>
