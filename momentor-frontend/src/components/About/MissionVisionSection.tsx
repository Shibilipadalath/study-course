...
export default function MissionVisionSection() {
  return (
    <section className="w-full pb-16 md:pb-28 pt-12 bg-black">
      <div className="container mx-auto px-6 md:px-10 lg:px-24 space-y-16 md:space-y-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          >
            ...
            {/* Overlay Image */}
            <div className="absolute -bottom-5 md:bottom-[-35px] -right-2.5 md:right-[-35px] border-4 md:border-8 border-black rounded-2xl hidden sm:block">
              <Image
                src="/images/about1.png"
                width={200}
                height={200}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          >
            ...
            <div className="absolute -top-5 md:top-[-35px] -left-2.5 md:left-[-35px] border-4 md:border-8 border-black rounded-2xl hidden sm:block">
              <Image
                src="/images/about1.png"
                width={200}
                height={200}
