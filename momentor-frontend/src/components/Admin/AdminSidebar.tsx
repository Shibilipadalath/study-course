...
export default function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 h-screen w-72 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900
      ...
      >
        ...
        <div className="p-4 lg:p-6 border-b border-gray-700/50 flex-shrink-0">
          <Link href="/admin" className="flex items-center gap-3" onClick={() => setIsMobileOpen(false)}>
            <div className="relative w-10 h-10 rounded-lg bg-gradient-to-br from-[#CF6943] to-[#b95c3b] flex items-center justify-center shadow-lg">
              ...
              >
                <Link
                  ...
                  className={`
                    ...
                    ${
                      isActive
                        ? "bg-gradient-to-r from-[#CF6943] to-[#b95c3b] text-white shadow-lg shadow-[#CF6943]/30"
                ...
                >
                  ...
                  <Icon
                    className={`
                      text-lg lg:text-xl flex-shrink-0 transition-transform duration-200
                  ...
                  {!isActive && (
                    <motion.div
                      className="absolute inset-0 rounded-xl bg-gradient-to-r from-[#CF6943]/10 to-transparent opacity-0 group-hover:opacity-100"
        ...
        {/* Logout Button */}
        <div className="p-3 lg:p-4 border-t border-gray-700/50 flex-shrink-0">
          <motion.button
          ...
          >
            <HiArrowRightOnRectangle className="text-lg lg:text-xl flex-shrink-0 group-hover:rotate-12 transition-transform duration-200" />
        ...
        <div className="p-3 lg:p-4 border-t border-gray-700/50 flex-shrink-0">
          <div className="flex items-center gap-2 lg:gap-3 px-2 py-2 rounded-lg hover:bg-gray-700/30 transition-colors cursor-pointer">
            <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-br from-[#CF6943] to-[#b95c3b] flex items-center justify-center text-white font-semibold flex-shrink-0 text-sm lg:text-base">
              A
            </div>
